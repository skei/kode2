...
// 768862d9-c03f-47bd-abab-3273ad77c358
uint8_t myPluginId[16]  = {0x76,0x88,0x62,0xd9,0xc0,0x3f,0x47,0xbd,0xab,0xab,0x32,0x73,0xad,0x77,0xc3,0x58};
...
private:
  ...
  void recalc(float srate) {
    l0   = floorf( slider4/1000*srate+1 );
    l1   = 3;
    l2   = 13;
    l3   = 31;
    l4   = 103;
    ...
    l11  = 1213;
    l12  = 1553;
    Rl0  = floorf( slider4/1000*srate+1 );
    Rl1  = 3;
    Rl2  = 11;
    Rl3  = 37;
    Rl4  = 113;
    ...
    g9  = 0.62;
    g11 = 0.62;
    f   = expf( logf(0.001) / ( slider3*srate / (l5+l6+l7+l8) ) );
    d   = expf( -2*KODE_PI*18000/srate );
    dry = powf(10,(slider1/20)); // 10^(slider1/20);
    wet = powf(10,(slider2/20)); // 10^(slider2/20);
  }
