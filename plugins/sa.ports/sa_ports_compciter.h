...
// ad741f2a-810a-4103-97dc-081590cecde2
const uint8_t myPluginId[16]  = {0xad,0x74,0x1f,0x2a,0x81,0x0a,0x41,0x03,0x97,0xdc,0x08,0x15,0x90,0xce,0xcd,0xe2};
  ...
  */
  ...
  void on_processBlock(KODE_ProcessContext* AContext) final {
    ...
    for (uint32_t i=0; i<len; i++) {
      ...
      float rms = KODE_Max( abs(spl0) , abs(spl1) );
      ...
      if (gain > seekgain) {
        ...
        gain = KODE_Min( gain/release , seekgain );
      }
