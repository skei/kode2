...
//  virtual void  clear() {}
//  virtual void  clear(KODE_Color color) {}
//  virtual void  dirty() {}
...
//  virtual void  setColor(KODE_Color color) {}
...
//
//  virtual void  gradientAddStop(float pos, KODE_Color color) {}
...
//
//  virtual void  setPixel(uint32_t x, uint32_t y, KODE_Color color) {}
...
//public:
//
//  virtual void drawLine(float x1, float y1, float x2, float y2, KODE_Color color) {}
//  virtual void drawRect(KODE_FRect rect, KODE_Color color) {}
//  virtual void drawEllipse(KODE_FRect rect, KODE_Color color) {}
//  virtual void drawPie(KODE_FRect rect, float a1, float a2, KODE_Color color) {}
//  virtual void drawText(float x, float y, const char* text, KODE_Color color) {}
//  virtual void drawText(KODE_FRect rect, const char* text, KODE_Color color, uint32_t alignment) {}
//  virtual void fillRect(KODE_FRect rect, KODE_Color color) {}
//  virtual void fillEllipse(KODE_FRect rect, KODE_Color color) {}
//  virtual void fillPie(KODE_FRect rect, float a1, float a2, KODE_Color color) {}
//  virtual void setClip(KODE_FRect rect) {}

//public:
//
//  virtual void  drawBitmap(int32_t ADstX, int32_t ADstY, KODE_Drawable* ASource) {}
//  virtual void  drawBitmap(int32_t ADstX, int32_t ADstY, KODE_Drawable* ASource, int32_t ASrcX, int32_t ASrcY, int32_t ASrcW, int32_t ASrcH) {}
//  virtual void  stretchBitmap(float ADstX, float ADstY, float ADstW, float ADstH, KODE_Drawable* ASource, float ASrcX, float ASrcY, float ASrcW, float ASrcH) {}
