...
: public KODE_Widget {
  ...
  public:
    ...
    KODE_Knob2Widget(KODE_Rect ARect, float AValue=0.0f, bool ABipolar=false)
    : KODE_Widget(ARect) {
      ...
      wdg_label = (KODE_TextWidget*)appendWidget( new KODE_TextWidget( KODE_Rect(X,Y,      W, 16), "text" ));
      wdg_knob  = (KODE_KnobWidget*)appendWidget( new KODE_KnobWidget( KODE_Rect(X,Y+16,   W, KS), AValue ));
      wdg_value = (KODE_TextWidget*)appendWidget( new KODE_TextWidget( KODE_Rect(X,Y+16+KS,W, 16), value_text ));
