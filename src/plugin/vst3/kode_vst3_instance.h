  ...
  */
  ...
  int32_t KODE_VST3_PLUGIN_API queryInterface(const KODE_Vst3Id _iid, void** obj) final {
    ...
    if (KODE_iidEqual(KODE_Vst3IKeyswitchController_iid,_iid) ) {
      //KODE_Vst3DPrint(" (IKeySwitchProcessor)\n");
