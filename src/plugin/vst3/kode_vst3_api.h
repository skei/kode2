...
public:
	...
	virtual int32_t VST3_PLUGIN_API getProgramListInfo(int32_t listIndex, VST3_ProgramListInfo& info) = 0;
...
public:
	...
	virtual int32_t VST3_PLUGIN_API getEvent (int32_t index, VST3_Event& e) = 0;
	virtual int32_t VST3_PLUGIN_API addEvent (VST3_Event& e) = 0;
	static const VST3_IID iid;
};
