#ifndef kode_tcc_included
#define kode_tcc_included
//----------------------------------------------------------------------
/*
...
#define KODE_TCC_FILETYPE_BINARY   1
#define KODE_TCC_FILETYPE_C        2
#define KODE_TCC_FILETYPE_ASM      3
#define KODE_TCC_FILETYPE_ASM_PP   4

#define KODE_TCC_OUTPUT_MEMORY     1   // output will be run in memory (default)
#define KODE_TCC_OUTPUT_EXE        2   // executable file
#define KODE_TCC_OUTPUT_DLL        3   // dynamic library
#define KODE_TCC_OUTPUT_OBJ        4   // object file
#define KODE_TCC_OUTPUT_PREPROCESS 5   // only preprocess (used internally)
#define KODE_TCC_RELOCATE_AUTO     (void*)1
