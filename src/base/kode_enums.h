...
enum KODE_EWidgetAlignment {
  ...
  KODE_WIDGET_ALIGN_FILL_RIGHT    = 8,
  KODE_WIDGET_ALIGN_FILL_TOP      = 9,
  KODE_WIDGET_ALIGN_FILL_BOTTOM   = 10,
//KODE_WIDGET_ALIGN_LEFT          = 11,
  KODE_WIDGET_ALIGN_LEFT_TOP      = 12,
  KODE_WIDGET_ALIGN_LEFT_CENTER   = 13,
  KODE_WIDGET_ALIGN_LEFT_BOTTOM   = 14,
//KODE_WIDGET_ALIGN_RIGHT         = 15,
  KODE_WIDGET_ALIGN_RIGHT_TOP     = 16,
  KODE_WIDGET_ALIGN_RIGHT_CENTER  = 17,
  KODE_WIDGET_ALIGN_RIGHT_BOTTOM  = 18,
//KODE_WIDGET_ALIGN_TOP           = 19,
  KODE_WIDGET_ALIGN_TOP_LEFT      = 20,
  KODE_WIDGET_ALIGN_TOP_CENTER    = 21,
  KODE_WIDGET_ALIGN_TOP_RIGHT     = 22,
//KODE_WIDGET_ALIGN_BOTTOM        = 23,
  KODE_WIDGET_ALIGN_BOTTOM_LEFT   = 24,
  KODE_WIDGET_ALIGN_BOTTOM_CENTER = 25,
  KODE_WIDGET_ALIGN_BOTTOM_RIGHT  = 26,
  KODE_WIDGET_ALIGN_STACK_HORIZ   = 27,
  KODE_WIDGET_ALIGN_STACK_VERT    = 28
};
