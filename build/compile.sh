...
#g++ -Wall -std=c++11 -m64 -fexceptions -Wl,--as-needed -O3 -O2 -fPIC -Wl,--as-needed -faligned-new -msse4 -mfpmath=sse -DKODE_PLUGIN_VST3 -I../../src -c /DISKS/sda2/code/git/kode2/build/build.cpp -o obj/release/build/build.o

#g++ -shared  obj/release/build/build.o  -o ../../bin/kode_release.vst3/Contents/x86_64-linux/kode_release.so -m64 -s -fPIE  -lrt -lpthread -lxcb -lxcb-util -lxcb-image -lxcb-cursor -lxcb-keysyms -lcairo -lportaudio -lSDL2 -lSDL2_image -lSDL2_mixer
